...
export const Button = {
  render: () => ({
    ...
    template: '<IOButtonFilledMedium @click="onClick">Click Me</IOButtonFilledMedium><br><br><IOButtonFilledMedium @click="onClick" disabled>Click Me</IOButtonFilledMedium>',
  }),
};
